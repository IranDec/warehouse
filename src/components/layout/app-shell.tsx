...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const { isMobile } = useSidebar(); // Get isMobile from context for conditional rendering
  ...
  return (
    <SidebarProvider defaultOpen>
      <div className={cn("flex min-h-screen w-full bg-background", {"overflow-hidden": isMobile && useSidebar().openMobile})}>
